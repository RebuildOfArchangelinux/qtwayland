...
void tst_scaling::scaledWindow()
{
    ...
    exec([=] {
        ...
        fractionalScale()->send_preferred_scale(wl_fixed_from_double(1.5));
    ...
    exec([=] {
        QVERIFY(fractionalScale());
        fractionalScale()->send_preferred_scale(wl_fixed_from_double(2.5));
    });
...
void tst_scaling::roundingPolicy()
{
    ...
    exec([=] {
        QVERIFY(fractionalScale());
        fractionalScale()->send_preferred_scale(wl_fixed_from_double(scale));
